...
export async function createDeliverySchedule(pickUpDate, pickUpTime) {
...
// get order history (dari view level student di order list)
export async function getOrderHistory(date) {
  return await fetchAPI(`/api/food-supply/order-history?date=${date}`);
}

// qr scanner
export async function scanPlateQR(rawQR) {
  return await fetchAPI(
    `/api/mbg-food-distribution-tracker/food-distributor/qr-scanner`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
// assign order to plate
export async function assignOrderToPlate(orderId, plateCode) {
  return await fetchAPI(
    `/api/mbg-food-distribution-tracker/food-distributor/assign-order-to-plate/${orderId}`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
// start delivery (isi delivery form)
export async function startDelivery(orderId, payload) {
  return await fetchAPI(
    `/api/mbg-food-distribution-tracker/food-distributor/start-delivery/${orderId}`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      ...
      body: JSON.stringify(payload), 
      // payload = { pickUpDate, pickUpTime, plateCode, studentId, foodId }
    }
  );
}

// de-assign order to plate
export async function deAssignOrderFromPlate(plateCode) {
  return await fetchAPI(
    `/api/mbg-food-distribution-tracker/food-distributor/deassign-order-from-plate`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function pickupFromCatering(plateCode) {
  return await fetchAPI(
    "/api/mbg-food-distribution-tracker/food-distributor/pickup-from-catering",
    {
      method: "POST",
...
// catering ambil piring kembali dari sekolah
export async function pickupFromSchool(plateCode) {
  return await fetchAPI(
    "/api/mbg-food-distribution-tracker/food-distributor/pickup-from-school",
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ plateCode }),
